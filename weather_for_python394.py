#WARNING: This program may ONLY SUIT FOR Python 3.9.4
...
#防止Python低版本导致的日期编码错误
try:
    print('现在是'+datetime.date.today().__format__('%Y年%m月%d日 %a.'),datetime.datetime.now().strftime('%H:%M:%S'))
except UnicodeEncodeError:
    print('发生错误，程序已终止运行！')
    print('这可能是在低版本Python下运行该程序导致的问题。')
    sys.exit()
